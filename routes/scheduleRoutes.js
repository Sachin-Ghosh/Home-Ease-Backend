...
router.get('/filter', scheduleController.filterSchedules); // Filter schedules
router.get('/:vendorId', scheduleController.getVendorSlots); // Get available slots for a vendor
